...
internal fun canSeeHero(gameField: GameField, heroPosition: Position, mobPosition: Position): Boolean {
...
internal fun getAvailableNextPositions(gameField: GameField, position: Position): List<Position> {
